...
<head>
    ...
    <title>LMS||||Manage Librarian</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Manage Librarians</a></li>
                            <li class="active">Manage Librarians</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage Librarians</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
