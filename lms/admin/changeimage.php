...
{               ?>
                                <div class="form-group"><label for="company" class=" form-control-label">Librarian Name</label><input type="text" name="subjects" value="<?php  echo $row->Name;?>" class="form-control" id="subjects" readonly='true'></div>
