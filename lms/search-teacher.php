...
<head>
    ...
    <title>LMS|| Librarian Search</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-dark">
   ...
   <?php include_once('includes/header.php');?>
    ...
    <!--================Contact Area =================-->
    <section class="home_banner_area contact_area section_gap bg-dark">
        <div class="container">
...
$sdata=$_POST['searchteacher'];
  ?>
   <div class="text-center">
        <h2 style="color: white;">Librarians Search Results matching: <?php echo $sdata;?></h2>
