...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
    ...
    echo '<script>alert("Librarian detail has been updated")</script>';
...
<head>
    ...
    <title>LMS|| Update Librarian</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Update Librarian</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Librarian</strong><small> Detail</small></div>
...
<div class="form-group">
<label for="company" class=" form-control-label">Pic</label> &nbsp;<img src="images/<?php echo $row->Picture;?>" width="100" height="100" value="<?php  echo $row->Picture;?>">
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Address</label><textarea type="text" name="address" id="address" class="form-control" rows="5" cols="12" required="true"><?php  echo $row->Address;?></textarea></div>
</div>
<div class="col-12">
